...
local debuffs = {
    [1030] = { -- Temple of Sethraliss
		...
		["general"] = {
            ...
            272696, -- Rel�mpagos embotellados -- FIXME:
            272699, -- Flema venenosa
            268013, -- Choque de llamas
            268007, -- Ataque al coraz�n -- FIXME:
	...
	[1001] = { -- Freehold
		...
		[2094] = { -- Ring of Booty
            ...
            256363, -- Pu�etazo desgarrador -- FIXME:
		},
		[2095] = { -- Harlan Sweete
	...
	[1022] = { -- The Underrot
		...
		["general"] = {
            ...
            265468, -- Maldici�n fulminante -- FIXME:
            272609, -- Mirada enloquecedora
            265511, -- Drenaje de esp�ritu -- FIXME:
	...
	[968] = { -- Atal'Dazar
		...
		[2036] = { -- Vol'kaal
            ...
            255620, -- Erupci�n purulenta -- FIXME:
		},
		[2083] = { -- Rezan
