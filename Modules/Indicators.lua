...
if Cell.isRetail then
    indicatorSettings = {
        ...
        ["missingBuffs"] = {I:GetMissingBuffsString()..(L["%s in General must be enabled to make this indicator work"]:format(Cell:GetAccentColorString()..L["Buff Tracker"].."|r")), "enabled", "num:5", "orientation", "size-square", "position", "frameLevel"},
    }
