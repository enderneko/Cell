...
local buffs = {
    ...
    ["PWF"] = {id=21562, glowColor={F.GetClassColor("PRIEST")}, provider="PRIEST", level=22},

    -- 1459: Arcane Brilliance
    ["AB"] = {id=1459, glowColor={F.GetClassColor("MAGE")}, provider="MAGE", level=58},

    -- 6673: Battle Shout
    ["BS"] = {id=6673, glowColor={F.GetClassColor("WARRIOR")}, provider="WARRIOR", level=42},

    -- 469: Commanding Shout
    ["CS"] = {id=469, glowColor={F.GetClassColor("WARRIOR")}, provider="WARRIOR", level=68},

    -- 1126: Mark of the Wild
    ["MotW"] = {id=1126, glowColor={F.GetClassColor("DRUID")}, provider="DRUID", level=62},

    -- 20217: Blessing of Kings
    ["BoK"] = {id=20217, glowColor={F.GetClassColor("PALADIN")}, provider="PALADIN", level=30},

    -- 19740: Blessing of Might
    ["BoM"] = {id=19740, glowColor={F.GetClassColor("PALADIN")}, provider="PALADIN", level=81},
}
