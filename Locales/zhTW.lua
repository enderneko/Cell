...
L["Font Outline"] = "文字樣式"
L["Font Size"] = "文字大小"
L["For addons/WAs not dependent on LibGetFrame, use %s"] = "對於不依賴 LibGetFrame 的插件或WA，使用 %s"
L["Format"] = "格式"
L["Frame Level"] = "框架層級"
...
L["Hide Placeholder Frames"] = "隱藏預留位置框架"
...
L["Ignore UNIT_AURA payloads"] = "忽略 UNIT_AURA 事件的載荷"
L["Import"] = "匯入"
...
L["None"] = "無"
L["NON-EN"] = "中"
L["Non-integer scaling may result in abnormal display of options UI"] = "非整數縮放可能導致選項介面顯示不正常"
L["Normal"] = "一般"
...
L["Override LibGetFrame.GetUnitFrame"] = "覆寫 LibGetFrame.GetUnitFrame"
L["P"] = "PvP 天賦"
L["Particles"] = "粒子數"
L["Party"] = "隊伍"
L["Patrons"] = "贊助"
...
L["Smart Resurrection"] = "智能複活"
L["Smooth"] = "平滑"
L["SNIPPETS_TIPS"] = "[點兩下]改名。[Shift+左鍵]刪除。所有已勾選的程式碼片段將會在 Cell 初始化階段的最後自動執行 (即 ADDON_LOADED 事件中)。"
L["Solid"] = "單色"
...
L["Thickness"] = "粗細"
L["This may cause unknown issues"] = "可能導致未知問題"
L["This may help solve issues of indicators not updating correctly"] = "可能有助於指示器不能正確更新的問題"
