...
L["Common"] = "共用"
L["Copy"] = "複製"
L["Copy Indicators"] = "複製指示器"
L["Copy selected indicators to another layout"] = "將選擇的指示器複製到其他版面配置"
L["Create"] = "建立"
...
L["Health Bar Alpha"] = "血條透明度"
-- L["Health Bar Color"] = "血量顏色" -- Needs Review
L["Health Loss Alpha"] = "損失血量透明度"
-- L["Health Loss Color"] = "背景顏色" -- Needs Review
L["Health Text"] = "血量文字"
L["Height"] = "高度"
L["Hide"] = "隱藏"
...
-- L["onlyShowTopGlow"] = "只顯著標示當前減益" -- Needs Review
L["Options"] = "選項"
...
L["World Marks"] = "世界標記"
L["Would you like Cell to create a \"Healers\" indicator (icons)?"] = "需要 Cell 為你建立一個 “Healers” 指示器（圖示組）？"
L["X Offset"] = "水平位置偏移"
L["Y Offset"] = "垂直位置偏移"
L["Yes"] = "是"
L["You"] = "你"
