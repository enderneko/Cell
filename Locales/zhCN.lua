...
L["Glow"] = "发光"
L["Glow Options"] = "发光选项"
L["Power Infusion Request"] = "让我康康哪个家伙想吃宝宝的能量灌注"
L["Glow unit button when a group member send a PI request"] = "当队内成员请求能量灌注时高亮其单位按钮"
L["Priest Only"] = "仅当我是牧师时"
L["Free Cooldown Only"] = "仅当能量灌注不在冷却时"
