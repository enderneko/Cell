...
L["This setting will be ignored, if the %1$s option in %2$s tab is checked"] = "如果启用了%2$s页面下的%1$s选项，此设置将被忽略"
L["Name Color"] = "名字颜色"
...
L["CHANGELOGS"] = [[
    ...
    <p>* 更新部分指示器的字体选项。现在层数和持续时间的字体可以分别设置了。如果你使用了“暴雪样式图标”的代码片段，需要在Cell的仓库里找更新，否则报错。</p>
