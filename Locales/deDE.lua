...
L["Dispels"] = "Dispels"
L["Display a gradient texture when the unit receives a heal from your certain healing spells."] = "Zeige eine Gradiententextur an, wenn ein Gruppenmitglied eine Heilung von bestimmten AoE-Heilzaubern erhält."
